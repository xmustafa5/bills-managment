...
<template>
  <Transition name="modal">
    <div v-if="model" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
     <div class="flex flex-col w-fit justify-center items-center p-[2px]   relative  bg-[#2c2d2e] rounded-lg
  ...
  ">
      <div class="bg-[#131415]  max-w-2xl w-full mx-4 shadow-xl rounded-t-[6px] overflow-hidden">
        <div v-if="$slots.title || title" class="border-b relative bg-[#000]  border-[#2c2d2e] px-6 py-4">
<div
