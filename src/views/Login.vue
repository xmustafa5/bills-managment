...
<template>
  <div class="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-black to-[#131415]">
    <div class="max-w-md w-full bg-[#131415] rounded-xl shadow-2xl overflow-hidden border border-[#2c2d2e]">
        ...
        <Form class="space-y-5" :validation-schema="schema" @submit="handleLogin">
          ...
          <div class="flex items-center justify-between text-sm mt-2">
            <div class="flex items-center">
              <input id="remember-me" type="checkbox" class="h-4 w-4 rounded border-gray-600 bg-[#1c1d1f] text-indigo-600 focus:ring-indigo-500" />
